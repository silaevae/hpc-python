...
static PyMethodDef __pyx_mdef_10mandel_cyt_1compute_mandel = {"compute_mandel", (PyCFunction)__pyx_pw_10mandel_cyt_1compute_mandel, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10mandel_cyt_1compute_mandel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("compute_mandel (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_cr)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ci)) != 0)) kw_args--;
        else {
        ...
        case  4:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_lim);
 ...
 */
  ...
  if (__pyx_t_10) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_10); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  } else {
 ...
 *             y = grid_x[j]
 */
    __pyx_t_13 = __Pyx_PyInt_As_long(__pyx_v_N); if (unlikely((__pyx_t_13 == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
 ...
 */
      ...
      __pyx_v_x = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_pybuffernd_grid_x.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_grid_x.diminfo[0].strides));
 ...
 */
      ...
      __pyx_v_y = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_pybuffernd_grid_x.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_grid_x.diminfo[0].strides));
 ...
 * 
 */
      __pyx_t_17 = __pyx_PyFloat_AsDouble(__pyx_v_cr); if (unlikely((__pyx_t_17 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
      __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_v_ci); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
      __pyx_t_19 = __pyx_PyFloat_AsDouble(__pyx_v_lim); if (unlikely((__pyx_t_19 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
      __pyx_t_20 = __Pyx_PyInt_As_int(__pyx_v_cutoff); if (unlikely((__pyx_t_20 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
      __pyx_t_21 = __pyx_v_i;
      __pyx_t_22 = __pyx_v_j;
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_mandel.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_mandel.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_mandel.diminfo[1].strides) = __pyx_f_10mandel_cyt_kernel(__pyx_v_x, __pyx_v_y, __pyx_t_17, __pyx_t_18, __pyx_t_19, __pyx_t_20);
    }
  }
 ...
 */
  ...
  __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_time); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_10 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
    __pyx_t_10 = PyMethod_GET_SELF(__pyx_t_3);
  ...
  if (__pyx_t_10) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_10); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  } else {
 ...
 *     mandel = np.empty((N, N), dtype=int)
 */
  __pyx_tuple__10 = PyTuple_Pack(13, __pyx_n_s_cr, __pyx_n_s_ci, __pyx_n_s_N, __pyx_n_s_bound, __pyx_n_s_lim, __pyx_n_s_cutoff, __pyx_n_s_mandel, __pyx_n_s_grid_x, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_t0); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(6, 0, 13, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_mandel_cyt_pyx, __pyx_n_s_compute_mandel, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initmandel_cyt(void); /*proto*/
PyMODINIT_FUNC initmandel_cyt(void)
#else
PyMODINIT_FUNC PyInit_mandel_cyt(void); /*proto*/
PyMODINIT_FUNC PyInit_mandel_cyt(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_mandel_cyt(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init mandel_cyt", 0, __pyx_lineno, __pyx_filename);
    }
